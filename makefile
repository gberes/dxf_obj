...
ifeq ($(CC),em++)
	...
	LDFLAGS=-lglut -lGLESv2 -lm -stdlib=libc++ -g # -fsanitize=address -fsanitize-memory-track-origins
endif
endif

SOURCES=main.cpp test_creationclass.cpp lib/dl_dxf.cpp lib/dl_writer_ascii.cpp
